...
substrate = NEAT.Substrate([(x, y) for x in range(10) for y in range(21)],
                     [],
                     [(x, 21) for x in range(6)])
...
substrate.m_output_nodes_activation = NEAT.ActivationFunction.RELU
